...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-11 bg-muted/55 px-3 text-left align-middle font-mono text-[10px] font-semibold whitespace-nowrap text-muted-foreground uppercase tracking-[0.12em] [&:has([role=checkbox])]:pr-0',
        className,
      )}
      {...props}
    />
